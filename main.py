...
lora = LoRa.LoRa(RFM95_SPIBUS, RFM95_INT, CLIENT_ADDRESS2, RFM95_CS, picoLogger, reset_pin=RFM95_RST, freq=RF95_FREQ, tx_power=RF95_POW, acks=True)
...
while True:
    ...
    if(message):
        ...
        lora.send_to_wait_relay(str(message), Send_To_ADDRESS, Send_To_Relay_Addresses)
        led.toggle()
